...
class drupal {
    exec {
        ...
        "install-drupal":
            command => '/home/vagrant/.composer/vendor/bin/drush site-install --db-url=mysql://vagrant:vagrant@localhost:3306/vagrant --account-name=admin --account-pass=admin --site-name=D7 -y',
            cwd => '/vagrant/docroot',
